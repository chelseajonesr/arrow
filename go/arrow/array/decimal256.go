...
func (a *Decimal256) SetReflectValue(v reflect.Value, i int, reflectMapping *arrow.ReflectMapping) {
...
func (b *Decimal256Builder) AppendReflectValue(v reflect.Value, reflectMapping *arrow.ReflectMapping) error {
	for v.Kind() == reflect.Pointer {
		v = v.Elem()
	}
